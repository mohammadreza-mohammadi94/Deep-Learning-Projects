...
# def rnn_model(vocab_size, embedding_dim=100, max_len=100):
#     """
#     Build and compile a Simple RNN model for sentiment analysis.
...
#         tf.keras.layers.Bidirectional(tf.keras.layers.SimpleRNN(64, return_sequences=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))),
...
# def lstm_model(vocab_size, embedding_dim=100, max_len=100):
#     """
#     Build and compile an LSTM model for sentiment analysis.
...
#         tf.keras.layers.Embedding(vocab_size, embedding_dim, input_length=max_len),
#         tf.keras.layers.Dropout(0.3),
#         tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(64, return_sequences=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))),
#         tf.keras.layers.Dropout(0.7),
#         tf.keras.layers.Dense(16, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(0.01)),
#         tf.keras.layers.Dropout(0.7),
#         tf.keras.layers.Dense(1, activation='sigmoid')
